    ...
    public static void main(String[] args) {
        try {
            FingerPrint fp1 = new FingerPrint(ImageIO.read(new File(
                    "/Users/ruixu/Desktop/candidate1.png")));
            FingerPrint fp2 = new FingerPrint(ImageIO.read(new File(
                    "/Users/ruixu/Desktop/target2.png")));
          //  System.out.println(fp1.toString(true));
            System.out.printf("sim=%f", fp1.compare(fp2));
         //   System.out.println(compare("/Users/ruixu/Desktop/candidate1.png","/Users/ruixu/Desktop/target2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    public static double compare(String targetPath,String candidatePath) {
    	...
    	try {
            converToGrey cc=new converToGrey();
      	    cc.convert(targetPath);
      	    cc.convert(candidatePath);
        	  ...
        	  res=fp1.compare(fp2);
        	  if(res<0.7) {
        		 // System.out.println("res small 0.7");
        		  covertColor c=new covertColor();
        		  c.convertColor(candidatePath);
    	...
    	System.out.println("simility is :"+res);
    	return res;
    }
